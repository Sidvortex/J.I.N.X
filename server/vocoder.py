...
class Vocoder:
    def __init__(self):
        ...
        if GEMINI_AVAILABLE and GEMINI_API_KEY != "PASTE_YOUR_KEY_HERE":
            try:
                self.brain = genai.Client(api_key=GEMINI_API_KEY)
    ...
    def incinerate(self, person_name="someone", extra_info=""):
        ...
        if not self.brain:
            ...
            fallbacks = [
                ...
                f"Hey {person_name}, I cant connect to my roast engine. Thats the nicest thing thatll happen to you today.",
        ...
        try:
            ...
            return f"I tried to roast you {person_name} but even Googles AI crashed. That says something."
    ...
    def parse_order(self, text):
        ...
        # --- SENTINEL MODE ---
            ...
            self.syn.publish(TOPICS["sound"], json.dumps({"sfx": 2}))
        ...
        # --- ROAST ---
            ...
            self.syn.publish(TOPICS["sound"], json.dumps({"sfx": 3}))
        ...
        # --- REGISTER FACE ---
            ...
            if name:
                ...
                time.sleep(2)
                self.vocalize(f"Got it. Ill remember you, {name}. Probably.")
            else:
        ...
        # --- GOODNIGHT ---
            ...
            self.syn.publish(TOPICS["sound"], json.dumps({"sfx": 5}))
